...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [499] = {.count = 1, .reusable = true}, REDUCE(sym_last_command, 1, .production_id = 1),
  [501] = {.count = 1, .reusable = false}, REDUCE(sym_last_command, 1, .production_id = 1),
